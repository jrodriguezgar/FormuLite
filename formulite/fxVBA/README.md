# FormuLite - fxVBA Functions Documentation

## Overview

The `fxVBA` module provides VBA-compatible functions for FormuLite. These functions replicate VBA/Access behavior across multiple categories:
...
**Example:**
```python
from formulite.fxVBA.array_functions import Split
...
**Example:**
```python
from formulite.fxVBA.array_functions import Join_
...
**Example:**
```python
from formulite.fxVBA.array_functions import Filter_
...
**Example:**
```python
from formulite.fxVBA.array_functions import LBound
...
**Example:**
```python
from formulite.fxVBA.array_functions import UBound
...
**Example:**
```python
from formulite.fxVBA.array_functions import Array_
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CBool
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CByte
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CCur
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CDate
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CDbl
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CDec
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CInt
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CLng
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CSng
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CStr
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import CVar
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import DateValue
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import TimeValue
...
**Example:**
```python
from formulite.fxVBA.conversion_functions import Val
...
**Example:**
```python
from formulite.fxVBA.date_functions import Date_
...
**Example:**
```python
from formulite.fxVBA.date_functions import DateAdd
...
**Example:**
```python
from formulite.fxVBA.date_functions import DateDiff
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import DatePart
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import DateSerial
...
**Example:**
```python
from formulite.fxVBA.date_functions import Day
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import Hour
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import Minute
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import Month
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import MonthName
...
**Example:**
```python
from formulite.fxVBA.date_functions import Now
...
**Example:**
```python
from formulite.fxVBA.date_functions import Second
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import Time_
...
**Example:**
```python
from formulite.fxVBA.date_functions import Timer
...
**Example:**
```python
from formulite.fxVBA.date_functions import TimeSerial
...
**Example:**
```python
from formulite.fxVBA.date_functions import WeekDay
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.date_functions import WeekDayName
...
**Example:**
```python
from formulite.fxVBA.date_functions import Year
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.math_functions import Abs_
...
**Example:**
```python
from formulite.fxVBA.math_functions import Atn
...
**Example:**
```python
from formulite.fxVBA.math_functions import Cos
...
**Example:**
```python
from formulite.fxVBA.math_functions import Exp
...
**Example:**
```python
from formulite.fxVBA.math_functions import Fix
...
**Example:**
```python
from formulite.fxVBA.math_functions import Int_
...
**Example:**
```python
from formulite.fxVBA.math_functions import Log
...
**Example:**
```python
from formulite.fxVBA.math_functions import Rnd
...
**Example:**
```python
from formulite.fxVBA.math_functions import Round_
...
**Example:**
```python
from formulite.fxVBA.math_functions import Sgn
...
**Example:**
```python
from formulite.fxVBA.math_functions import Sin
...
**Example:**
```python
from formulite.fxVBA.math_functions import Sqr
...
**Example:**
```python
from formulite.fxVBA.math_functions import Tan
...
**Example:**
```python
from formulite.fxVBA.logic_functions import Choose
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IIf
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsDate
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsError
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsNull
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsNumeric
...
**Example:**
```python
from formulite.fxVBA.logic_functions import Switch
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsArray
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsEmpty
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsObject
...
**Example:**
```python
from formulite.fxVBA.logic_functions import IsMissing
...
**Example:**
```python
from formulite.fxVBA.financial_functions import DDB
...
**Example:**
```python
from formulite.fxVBA.financial_functions import FV
...
**Example:**
```python
from formulite.fxVBA.financial_functions import IPmt
...
**Example:**
```python
from formulite.fxVBA.financial_functions import Pmt
...
**Example:**
```python
from formulite.fxVBA.financial_functions import PPmt
...
**Example:**
```python
from formulite.fxVBA.financial_functions import PV
...
**Example:**
```python
from formulite.fxVBA.financial_functions import Rate
...
**Example:**
```python
from formulite.fxVBA.financial_functions import SLN
...
**Example:**
```python
from formulite.fxVBA.financial_functions import SYD
...
**Example:**
```python
from formulite.fxVBA.financial_functions import NPV
...
**Example:**
```python
from formulite.fxVBA.financial_functions import IRR
...
**Example:**
```python
from formulite.fxVBA.financial_functions import MIRR
...
**Example:**
```python
from formulite.fxVBA.financial_functions import NPer
...
**Example:**
```python
from formulite.fxVBA.format_functions import Format_
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.format_functions import FormatCurrency
...
**Example:**
```python
from formulite.fxVBA.format_functions import FormatDateTime
from datetime import datetime
...
**Example:**
```python
from formulite.fxVBA.format_functions import FormatNumber
...
**Example:**
```python
from formulite.fxVBA.format_functions import FormatPercent
...
**Example:**
```python
from formulite.fxVBA.misc_functions import AccessError
...
**Example:**
```python
from formulite.fxVBA.misc_functions import CurrentUser
...
**Example:**
```python
from formulite.fxVBA.misc_functions import Eval_
...
**Example:**
```python
from formulite.fxVBA.misc_functions import Hex_
...
**Example:**
```python
from formulite.fxVBA.misc_functions import Oct_
...
**Example:**
```python
from formulite.fxVBA.misc_functions import SysCmd
...
**Example:**
```python
from formulite.fxVBA.misc_functions import RGB
...
**Example:**
```python
from formulite.fxVBA.misc_functions import QBColor
