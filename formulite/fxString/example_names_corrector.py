...
try:
    from string_grammar import SpellCorrector
    from string_similarity import WordSimilarity
except ImportError as e:
    print(f"Error al importar módulos. Asegúrate de que 'corrector_module.py' y 'similarity_module.py' están en el mismo directorio.")
...
def correct_and_validate_name(
    ...
    Args:
        ...
        spell_corrector (SpellCorrector): Instancia del corrector ortográfico.
    ...
    try:
        corrected_name = spell_corrector.correct_text(input_name)
...
def main():
    ...
    #    Pasamos ambos vocabularios al SpellCorrector para que pueda usarlos.
    #    SpellCorrector internamente maneja el vocabulario para correcciones.
    ...
    try:
        spell_corrector = SpellCorrector(custom_vocabulary=all_known_names, language='es')
