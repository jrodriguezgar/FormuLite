...
Este documento presenta casos de uso reales para el módulo **fxString** de FormuLite, con énfasis especial en **similitud de palabras** (word similarity) y **corrección ortográfica** (spellcheck).
...
```python
from formulite.fxString.string_similarity import calculate_similarity
...
El módulo **fxString** de FormuLite proporciona herramientas potentes y flexibles para:
